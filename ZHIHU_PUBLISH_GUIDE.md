...
1. 打开知乎：https://zhuanlan.zhihu.com/write
2. 复制标题
3. 复制文章内容
4. 选择分类：人工智能 / 程序员
5. 添加标签：AI绘画、梦幻风格、开源项目、技术解析
6. 添加配图（可选）：可以放3张 DreamForge 生成的图片
7. 点击"发布"
...
| 任务 | 频率 | 说明 |
|------|------|------|
| 回答相关问题 | 每周 2-3 次 | 回答 AI/图像生成相关问题，推荐项目 |
| 关注同类账号 | 每天 | 互动，增加曝光 |
| 评论他人文章 | 每周 1-2 次 | 增加账号活跃度 |
